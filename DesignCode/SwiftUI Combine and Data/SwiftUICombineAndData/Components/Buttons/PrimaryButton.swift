...
struct PrimaryButton: View {
	...
	var lightModeButton: some View {
		...
		.frame(height: 50)
		.background(LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.3373903036, green: 0.2152278125, blue: 0.887358427, alpha: 1)), Color(#colorLiteral(red: 0.6350396276, green: 0.5573728681, blue: 0.9254394174, alpha: 1))]), startPoint: .top, endPoint: .bottom))
		.cornerRadius(16)
